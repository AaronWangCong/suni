<template>
  <view class="nav-wrap">
    <view class="nav-title">
      <su-image :showLoading="true" src="https://suni.pages.dev/h5/static/uview/common/logo.png" width="70px" height="70px" />
      <view class="nav-info">
        <view class="nav-info__title" @tap="jumpToWx">
          <text class="nav-info__title__text">sun-uni</text>
          <!-- #ifdef MP-WEIXIN -->
