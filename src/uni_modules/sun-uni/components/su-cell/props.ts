...
export const cellProps = {
  ...
  /** 
   * 链接跳转的方式，内部使用的是sun-uni封装的route方法，可能会进行拦截操作
   * @default navigateTo
   */
  linkType: {
    type: String,
  ...
  /** 单位元的大小，可选值为large，normal，mini */
  size: {
    type: String as PropType<'large' | 'normal' | 'mini'>,
...
export type SuCellProps = ExtractPropTypes<typeof cellProps>
