<template>
	<view
	    class="su-switch cursor-pointer"
	    :class="[disabled && 'su-switch--disabled']"
	...
	>
		...
		<view
		    class="su-switch__node"
		    <!-- #ifdef VUE3 -->
			:class="[modelValue && 'su-switch__node--on']"
			<!-- #endif -->
			<!-- #ifdef VUE2 -->
			:class="[value && 'su-switch__node--on']"
			<!-- #endif -->
		    :style="[nodeStyle]"
		    ref="su-switch__node"
		>
...
<script>
	 ...
	 * @tutorial https://suni.pages.dev/sun-uni/component/switch.html
	 ...
	 * @example <su-switch v-model="checked" active-color="red" inactive-color="#eee"></su-switch>
	 */
	export default {
		name: 'su-switch',
