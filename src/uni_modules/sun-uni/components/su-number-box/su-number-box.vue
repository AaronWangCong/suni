<template>
  <view class="su-number-box">
    <view
      class="su-number-box__slot cursor-pointer"
    ...
    <view
      v-else-if="showMinus"
      class="su-number-box__minus cursor-pointer"
      @tap.stop="clickHandler('minus')"
      @touchstart="onTouchStart('minus')"
      @touchend.stop="clearTimeout"
      hover-class="su-number-box__minus--hover"
      hover-stay-time="150"
      :class="{ 'su-number-box__minus--disabled': isDisabled('minus') }"
      :style="[buttonStyle('minus')]"
    >
      <su-icon name="minus" :color="isDisabled('minus') ? '#c8c9cc' : '#323233'" size="15" bold :customStyle="iconStyle"></su-icon>
    </view>
    ...
    <slot name="input">
      ...
      <input
        ...
        :class="{ 'su-number-box__input--disabled': disabled || disabledInput }"
        :value="currentValue"
        class="su-number-box__input"
        @blur="onBlur"
        @focus="onFocus"
        @input="onInput"
        type="number"
    ...
    <view
      v-else-if="showPlus"
      class="su-number-box__plus cursor-pointer"
      @tap.stop="clickHandler('plus')"
      @touchstart="onTouchStart('plus')"
      @touchend.stop="clearTimeout"
      hover-class="su-number-box__plus--hover"
      hover-stay-time="150"
      :class="{ 'su-number-box__minus--disabled': isDisabled('plus') }"
      :style="[buttonStyle('plus')]"
    >
      <su-icon name="plus" :color="isDisabled('plus') ? '#c8c9cc' : '#323233'" size="15" bold :customStyle="iconStyle"></su-icon>
    </view>
  </view>
</template>
 ...
 * @tutorial https://suni.pages.dev/component/numberBox.html
 ...
 * @example <su-number-box v-model="value" @change="valChange"></su-number-box>
 */
export default {
  name: 'su-number-box',
...
$su-numberBox-hover-bgColor: #e6e6e6 !default;
$su-numberBox-disabled-color: #c8c9cc !default;
$su-numberBox-disabled-bgColor: #f7f8fa !default;
$su-numberBox-plus-radius: 4px !default;
$su-numberBox-minus-radius: 4px !default;
$su-numberBox-input-text-align: center !default;
$su-numberBox-input-font-size: 15px !default;
$su-numberBox-input-padding: 0 !default;
$su-numberBox-input-margin: 0 2px !default;
$su-numberBox-input-disabled-color: #c8c9cc !default;
$su-numberBox-input-disabled-bgColor: #f2f3f5 !default;
...
.su-number-box {
  ...
  &__minus {
    ...
    &--hover {
      background-color: $su-numberBox-hover-bgColor !important;
    }

    &--disabled {
      color: $su-numberBox-disabled-color;
      background-color: $su-numberBox-disabled-bgColor;
    }
  }

  &__plus {
    border-top-right-radius: $su-numberBox-plus-radius;
    border-bottom-right-radius: $su-numberBox-plus-radius;
  }

  &__minus {
    border-top-left-radius: $su-numberBox-minus-radius;
    border-bottom-left-radius: $su-numberBox-minus-radius;
  }

  &__input {
    position: relative;
    text-align: $su-numberBox-input-text-align;
    font-size: $su-numberBox-input-font-size;
    padding: $su-numberBox-input-padding;
    margin: $su-numberBox-input-margin;
    @include flex;
    align-items: center;
    justify-content: center;

    &--disabled {
      color: $su-numberBox-input-disabled-color;
      background-color: $su-numberBox-input-disabled-bgColor;
    }
  }
}
</style>
