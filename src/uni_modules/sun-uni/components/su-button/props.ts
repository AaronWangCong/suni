...
export const buttonProps = {
   ...
   */
  size: {
    type: String as PropType<SuButtonSize>,
    default: () => defProps.button.size
  },
  /**
   * 按钮形状，circle（两边为半圆），square（带圆角）方形
   * @default square
   */
  shape: {
    type: String,
  ...
  */
   ...
   */
  lang: {
    type: String as PropType<UniHelper.ButtonLang>,
...
/** 按钮组件的mixin * */
export const buttonMixinProps = {
  lang: String as PropType<UniHelper.ButtonLang>,
  sessionFrom: String,
  ...
  appParameter: String,
  formType: String as PropType<UniHelper.ButtonFormType>,
  openType: String as PropType<UniHelper.ButtonOpenType>
}

/** 按钮大小 */
export type SuButtonSize = 'large' | 'normal' | 'small' | 'mini'
/** 按钮prop */
export type SuButtonProps = ExtractPropTypes<typeof buttonProps> & UniHelper.ButtonProps & ExtractPropTypes<typeof baseProps>
