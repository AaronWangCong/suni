<template>
  <view class="su-sticky" :id="elId" :style="[style]">
    <view :style="[stickyContent]" class="su-sticky__content">
      <slot />
    </view>
  </view>
</template>
 ...
 * @tutorial https://suni.pages.dev/sun-uni/component/sticky.html
 ...
 * @example <su-sticky offsetTop="200"><view>塞下秋来风景异，衡阳雁去无留意</view></su-sticky>
 */
export default {
  name: 'su-sticky',
