<template>
  <view class="su-waterfall">
    <view ref="su-left-column" id="su-left-column" class="su-column">
      <slot name="left" :leftList="leftList"></slot>
    </view>
    <view ref="su-right-column" id="su-right-column" class="su-column">
 ...
 * @tutorial https://suni.pages.dev/component/waterfall.html
 * @property {Array} flow-list 用于渲染的数据
 * @property {String Number} add-time 单条数据添加到队列的时间间隔，单位ms，见上方注意事项说明（默认200）
 * @example <su-waterfall :flowList="flowList"></su-waterfall>
 */
...
export default {
  ...
  methods: {
    async splitData() {
      ...
      let leftRect = await this.$uGetRect('#su-left-column')
      let rightRect = await this.$uGetRect('#su-right-column')
