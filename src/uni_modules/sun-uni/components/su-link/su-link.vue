<template>
  <text class="su-link" @tap.stop="openLink" :style="[linkStyle, addStyle(customStyle)]">{{ text }}</text>
</template>
 ...
 * @tutorial https://suni.pages.dev/sun-uni/component/link.html
 * @property {String}			color		文字颜色 （默认 color['su-primary'] ）
 ...
 *
 * @example <su-link href="http://www.uviewui.com">蜀道难，难于上青天</su-link>
 */
export default {
  name: 'su-link',
...
$su-link-line-height: 1 !default;

.su-link {
  /* #ifndef APP-NVUE */
  line-height: $su-link-line-height;
  /* #endif */
  @include flex;
  flex-wrap: wrap;
  flex: 1;
