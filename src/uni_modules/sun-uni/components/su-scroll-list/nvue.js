...
export default {
  methods: {
    // 此处不写注释，请自行体会
    nvueScrollHandler(e) {
      const anchor = this.$refs['su-scroll-list__scroll-view'].ref
      let element = {}
      if (this.$refs['su-scroll-list__indicator__line__bar']) {
        element = this.$refs['su-scroll-list__indicator__line__bar'].ref
      }
