<template>
  <su-transition mode="slide-down" :customStyle="containerStyle" :show="open">
    <view class="su-notify" :class="[`su-notify--${tmpConfig.type}`]" :style="[backgroundColor, addStyle(customStyle)]">
      <su-status-bar v-if="tmpConfig.safeAreaInsetTop"></su-status-bar>
      <view class="su-notify__warpper">
        <slot name="icon">
          <su-icon
        ...
        <text
          class="su-notify__warpper__text"
          :style="{
 ...
 * @example <su-notify message="Hi uView"></su-notify>
 */
export default {
  name: 'su-notify',
...
$su-notify-padding: 8px 10px !default;
$su-notify-text-font-size: 15px !default;
$su-notify-primary-bgColor: $su-primary !default;
$su-notify-success-bgColor: $su-success !default;
$su-notify-error-bgColor: $su-error !default;
$su-notify-warning-bgColor: $su-warning !default;

.su-notify {
  padding: $su-notify-padding;
  ...
  &__warpper {
    ...
    &__text {
      font-size: $su-notify-text-font-size;
      text-align: center;
    }
  }

  &--primary {
    background-color: $su-notify-primary-bgColor;
  }

  &--success {
    background-color: $su-notify-success-bgColor;
  }

  &--error {
    background-color: $su-notify-error-bgColor;
  }

  &--warning {
    background-color: $su-notify-warning-bgColor;
  }
}
</style>
