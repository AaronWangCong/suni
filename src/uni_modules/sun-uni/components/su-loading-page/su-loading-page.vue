<template>
  ...
  >
    <view class="su-loading-page">
      <view class="su-loading-page__warpper">
        <view class="su-loading-page__warpper__loading-icon">
          <image
            v-if="image"
            :src="image"
            class="su-loading-page__warpper__loading-icon__img"
            mode="widthFit"
            :style="{
          ...
          ></image>
          <su-loading-icon v-else :mode="loadingMode" :size="addUnit(iconSize)" :color="loadingColor"></su-loading-icon>
        </view>
        <slot>
          <text
            class="su-loading-page__warpper__text"
            :style="{
...
$su-loading-icon-margin-bottom: 10px !default;
...
.su-loading-page {
  ...
  &__warpper {
    ...
    &__loading-icon {
      margin-bottom: $su-loading-icon-margin-bottom;
