<template>
	...
	>
		...
		>
			...
			<!-- 空布局 -->
			<MescrollEmpty v-if="isShowEmpty" :option="mescroll.optUp.empty" @emptyclick="emptyClick"></MescrollEmpty>
		...
		<MescrollTop v-model="isShowToTop" :option="mescroll.optUp.toTop" @click="toTopClick"></MescrollTop>

		<!-- #ifdef MP-WEIXIN || MP-QQ || APP-PLUS || H5 || APP-NVUE -->
...
<!-- #ifdef MP-WEIXIN || MP-QQ || APP-PLUS || H5 || APP-NVUE -->
<script src="../su-mescroll/wxs/wxs.wxs" module="wxsBiz" lang="wxs"></script>
<!-- #endif -->

<!-- app, h5使用renderjs -->
<!-- #ifdef APP-PLUS || H5 -->
<script module="renderBiz" lang="renderjs">
import renderBiz from "../su-mescroll/wxs/renderjs.js";
export default {
	mixins: [renderBiz]
}
</script>
...
import MeScroll from '../su-mescroll/utils/su-mescroll-uni'
// 引入全局配置
import GlobalOption from '../su-mescroll/utils/mescroll-uni-option'
// 引入国际化工具类
import mescrollI18n from '../su-mescroll/utils/mescroll-i18n'
// 引入回到顶部组件
import MescrollTop from '../su-mescroll-top/su-mescroll-top.vue'
// 引入空数据组件
import MescrollEmpty from '../su-mescroll-empty/su-mescroll-empty.vue'
// 引入兼容wxs(含renderjs)写法的mixins
import WxsMixin from '../su-mescroll/wxs/mixins.js'
			...
			switch (this.downLoadType) {
				...
				case 4:
					return this.mescroll.isDownEndSuccess
						...
						: this.mescroll.isDownEndSuccess == false
...
@import '../su-mescroll-down/mescroll-down.css';
@import '../su-mescroll-up/mescroll-up.css';
</style>
