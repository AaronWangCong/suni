...
export const inputProps = {
   ...
   */
  type: {
    type: String as PropType<UniHelper.InputType | 'password'>,
   ...
   * 参考input链接： https://uniapp.dcloud.io/component/input
   * 参考textarea链接：https://uniapp.dcloud.io/component/textarea
   * @default 'done'
   * */
  confirmType: {
    type: String as PropType<UniHelper.InputConfirmType>,
...
export type SuInputProps = ExtractPropTypes<typeof inputProps>
