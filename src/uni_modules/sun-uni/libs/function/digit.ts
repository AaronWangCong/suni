 ...
 */
export function digitLength(num: { toString: () => string }) {
 ...
 */
export function float2Fixed(num: { toString: any }) {
 ...
 * @private
 */
export function iteratorOperation(arr: any[], operation: { (...nums: any[]): any; (arg0: any, arg1: any): any }) {
