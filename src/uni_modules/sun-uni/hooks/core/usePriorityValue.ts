...
import { kebabToCamelCase } from '../../libs/function/letter'
import { getFirstNonNullOrUndefined } from '../../libs/function/inference'
 ...
 * @param state
 */
export function usePriorityValue<T extends Record<string, any>, S extends Record<string, any>, K extends keyof T = keyof T>(
  key: K,
  props: T,
 ...
 * @param state
 */
export function usePriorityValues<T extends Record<string, any>, S extends Ref<Record<string, any>> = Readonly<Ref<NoInfer<T>>>>(
  props: T,
  state: S | undefined
) {
 ...
 * @param state
 */
export function useForwardPriorityValues<T extends Record<string, any>, S extends Ref<Record<string, any>> = Readonly<Ref<NoInfer<T>>>>(
  props: T,
  state: S | undefined
) {
