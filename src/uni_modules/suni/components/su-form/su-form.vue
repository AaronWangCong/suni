<template>
  <view :class="`su-form ${customClass}`" :style="customStyle">
    <slot></slot>
    <su-toast v-if="props.errorType === 'toast'" selector="su-form-toast" />
  </view>
</template>
