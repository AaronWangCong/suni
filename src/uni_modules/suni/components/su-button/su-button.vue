<template>
  ...
  >
    <view v-if="loading" class="su-button__loading">
      <view class="su-button__loading-svg" :style="loadingStyle"></view>
    </view>
    <su-icon v-else-if="icon" custom-class="su-button__icon" :name="icon" :classPrefix="classPrefix"></su-icon>
    <view class="su-button__text"><slot /></view>
  </button>
</template>
