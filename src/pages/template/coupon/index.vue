  ...
  <view class="su-wrap">
    <view class="meituan">
      ...
      <view class="tips">
        ...
        <view class="explain su-line-1">满8.1元可用、限最新版本客户端使用</view>
    ...
    <view class="jingdong">
      ...
      <view class="right">
        <view class="top">
          ...
          <view class="bottom">
            <view class="date su-line-1">2020.01.01-2020.01.31</view>
      ...
      <view class="ticket">
        <view class="left">
          ...
          <view class="introduce">
            ...
            <view class="date su-line-1">2019.11.28-2020.1.24</view>
          </view>
        </view>
        <view class="right">
...
.meituan {
  ...
  .content {
    ...
    .right {
      ...
      .immediate-use {
        ...
        border-radius: 25rpx;
        line-height: 50rpx;
        background-color: $su-warning !important;
  ...
  .tips {
    padding: 0 20rpx;
    border: 10rpx;
    background-color: $su-info-light;
    position: relative;
    color: $su-tips-color;
    display: flex;
...
.jingdong {
  ...
  .right {
    ...
    font-size: 28rpx;
    .top {
      border-bottom: 2rpx dashed $su-border-color;
      .title {
        margin-right: 60rpx;
        line-height: 40rpx;
        .tag {
    ...
    .tips {
      ...
      .particulars {
        ...
        padding-top: 8rpx;
        border-radius: 50%;
        background-color: $su-info-disabled;
        text-align: center;
      }
    }
  }
