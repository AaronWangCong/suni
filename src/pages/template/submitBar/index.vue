  ...
  <view class="navigation">
    <view class="left">
      <view class="item">
        ...
        <view class="text su-line-1">客服</view>
      </view>
      <view class="item">
        <up-icon name="home" :size="20" :color="$u.color['contentColor']"></up-icon>
        <view class="text su-line-1">店铺</view>
      </view>
      <view class="item car">
        ...
        <view class="text su-line-1">购物车</view>
      </view>
    </view>
    <view class="right">
      <view class="cart btn su-line-1">加入购物车</view>
      <view class="buy btn su-line-1">立即购买</view>
    </view>
  </view>
</template>
