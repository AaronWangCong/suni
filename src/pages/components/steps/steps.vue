<template>
  <view class="su-page">
    <view class="su-demo-block">
      <text class="su-demo-block__title">基础演示</text>
      <view class="su-demo-block__content">
        <up-steps :current="current1">
          <up-steps-item title="已下单" desc="10:30" :itemStyle="{ backgroundColor: '#eee' }"></up-steps-item>
    ...
    <view class="su-demo-block">
      <text class="su-demo-block__title">显示点类型</text>
      <view class="su-demo-block__content">
        ...
        <up-steps :current="1" dot direction="column">
          <up-steps-item title="已下单" desc="10:30"></up-steps-item>
          <up-steps-item title="已出库" desc="10:35"></up-steps-item>
          <up-steps-item title="运输中" desc="11:40"></up-steps-item>
        </up-steps>
    ...
    <view class="su-demo-block">
      <text class="su-demo-block__title">错误状态</text>
      <view class="su-demo-block__content">
        <up-steps :current="1">
          <up-steps-item title="已下单" desc="10:30"></up-steps-item>
    ...
    <view class="su-demo-block">
      <text class="su-demo-block__title">自定义图标</text>
      <view class="su-demo-block__content">
    ...
    <view class="su-demo-block">
      <text class="su-demo-block__title">自定义插槽</text>
      <view class="su-demo-block__content">
        <up-steps :current="1">
          <up-steps-item title="已下单" desc="10:30"></up-steps-item>
          <up-steps-item title="已出库" desc="10:35"></up-steps-item>
    ...
    <view class="su-demo-block">
      <text class="su-demo-block__title">自定义颜色</text>
      <view class="su-demo-block__content">
    ...
    <view class="su-demo-block">
      <text class="su-demo-block__title">竖向展示</text>
      <view class="su-demo-block__content">
