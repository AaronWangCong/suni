...
<demo-model url="/pages/components/avatarCropper/index"></demo-model>
...
<template>
	<view class="wrap">
		<view class="su-avatar-wrap">
			<image class="su-avatar-demo" :src="avatar" mode="aspectFill"></image>
		</view>
		<su-button @tap="chooseAvatar">进入裁剪页</su-button>
	</view>
</template>
	...
	export default {
		...
		methods: {
			chooseAvatar() {
				...
				this.$u.route({
					// 关于此路径，请见下方"注意事项"
					url: '/uni_modules/sun-uni/component/su-avatar-cropper/su-avatar-cropper',
...
```js
{
	"path": "uni_modules/sun-uni/component/su-avatar-cropper/su-avatar-cropper",
	"style": {
...
您需要去`node_modules`文件中，按路径`/node_modules/sun-uni/component/su-avatar-cropper/su-avatar-cropper.vue`找到此文件，将其内容复制出来，
