...
<demo-model url="/pages/components/sticky/index"></demo-model>
...
[点击可以查看](https://github.com/AaronWangCong/suni/blob/main/src/pages/components/sticky/sticky.nvue) 右侧演示页面的源码
...
| z-index         | 吸顶时的`z-index`值 ,`NVUE`无效          | String \| Number | -       | -      |
