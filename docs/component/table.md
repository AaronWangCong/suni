...
<demo-model url="/pages/components/table/index"></demo-model>
...
由于`头条小程序`的兼容性问题，您需要给表格相关的组件(`su-tr`、`su-th`、`su-td`)写上对应的类名才有效，如下：

```html
<su-table>
	<su-tr class="su-tr">
		<su-th class="su-th">姓名</su-th>
		<su-th class="su-th">年龄</su-th>
		<su-th class="su-th">籍贯</su-th>
		<su-th class="su-th">性别</su-th>
	</su-tr>
	<su-tr class="su-tr">
		<su-td class="su-td">吕布</su-td>
		<su-td class="su-td">22</su-td>
		<su-td class="su-td">楚河</su-td>
		<su-td class="su-td">男</su-td>
	</su-tr>
</su-table>
```
...
<su-table>
	<su-tr>
		<su-td width="33.33333%">浙江大学</su-td>
		<su-td>
			<su-tr>
				<su-td>二年级</su-td>
				<su-td>22</su-td>
...
<su-table>
	<su-tr>
		<su-td width="66.66666%">浙江大学</su-td>
		<su-td>
			二年级
		</su-td>
	</su-tr>
