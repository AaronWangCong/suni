...
```html
<su-icon name="add-circle" color="#0083ff" />
```
...
```html
<su-icon name="add-circle" size="20px" />
```
...
<su-icon class-prefix="fish" name="kehuishouwu" />
```
...
| classPrefix | 类名前缀，用于使用自定义图标 | string | - | 'su-icon' | 0.1.27 |
