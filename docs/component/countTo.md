...
<demo-model url="/pages/components/countTo/index"></demo-model>
...
```html
<su-count-to :start-val="30" :end-val="500"></su-count-to>
```
...
```html
<su-count-to :start-val="30" :end-val="500" :duration="2000" :use-easing="false"></su-count-to>
```
...
```html
<su-count-to :start-val="30" :end-val="500.55" :decimals="2"></su-count-to>
```
...
```html
<su-count-to :end-val="1542" separator=","></su-count-to>
```
...
```html
<template>
  <su-count-to ref="uCountToRef" :end-val="endVal" :autoplay="autoplay"></su-count-to>
</template>
...
[点击可以查看](https://github.com/AaronWangCong/suni/blob/main/src/pages/components/countTo/countTo.nvue) 右侧演示页面的源码
