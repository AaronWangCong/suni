...
<demo-model url="/pages/components/noNetwork/index"></demo-model>
...
<template>
  <view>
    <su-no-network @disconnected="disconnected" @connected="connected" @retry="retry"></su-no-network>
    <view class="su-content">
      <view class="su-content__circle">
        <su-icon name="checkbox-mark" color="#fff" size="30"></su-icon>
      </view>
      <text class="su-content__normal">网络正常</text>
    </view>
  </view>
</template>
...
[点击可以查看](https://github.com/AaronWangCong/suni/blob/main/src/pages/components/noNetwork/noNetwork.nvue) 右侧演示页面的源码
