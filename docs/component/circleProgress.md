...
<demo-model url="/pages/components/progress/index"></demo-model>
...
```html
<template>
	<su-circle-progress active-color="#2979ff" :percent="80">
		<view class="su-progress-content">
			<view class="su-progress-dot"></view>
			<text class='su-progress-info'>查找中</text>
		</view>
	</su-circle-progress>
</template>
...
```html
<su-circle-progress type="primary" :percent="30" duration="2000"></su-circle-progress>
```
